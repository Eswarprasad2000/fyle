let checkBoxInputEl = document.getElementById("checkBoxInput");
let contactUsBtn = document.getElementById("contactUsBtn");
let lastNameEl = document.getElementById("lastNameEl");
let firstNamEl = document.getElementById("firstNamEl");
...
function submitFormData(formData) {
    ...
    let options = {
        ...
        headers: {
            ...
            Authorization: "Bearer 38e34d81c40a85de4449d02e8e9de9c1960b7802f111c83adde5a41dcfc82fcb",
        },
...
contactUsBtn.addEventListener("submit", function(event) {
...
firstNamEl.addEventListener("change", function(event) {
...
checkBoxInputEl.addEventListener("change", function(event) {
    if (event.target.value === "on") {
        formData.checkBox = "No";
    } else {
        formData.checkBox = "Yes";
    }
...
// wwdCard.addEventListener("mouseover", function() {
...
//     btnImg.classList.add("ml-2");
//     btnElement.appendChild(btnImg);
// });

// wwdCard.removeEventListener("mouseout", function() {
